...
#define zLicenseDescrip (autogen_opt_strs+269)
 ...
 */
static char const autogen_opt_strs[3228] =
/*     0 */ "autogen (GNU AutoGen) 5.18\n"
            "Copyright (C) 1992-2013 Bruce Korb, all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the GNU General Public License,\n"
            "version 3 or later <http://gnu.org/licenses/gpl.html>\n\0"
/*   269 */ "autogen is free software: you can redistribute it and/or modify it under\n"
            ...
            "You should have received a copy of the GNU General Public License along\n"
            "with this program.  If not, see <http://www.gnu.org/licenses/>.\n\0"
/*   872 */ "The following options select definitions, templates and scheme functions\n"
            "to use:\0"
/*   953 */ "Search for templates in DIR\0"
/*   981 */ "TEMPL_DIRS\0"
/*   992 */ "templ-dirs\0"
/*  1003 */ "Use TPL-FILE for the template\0"
/*  1033 */ "OVERRIDE_TPL\0"
/*  1046 */ "override-tpl\0"
/*  1059 */ "Load AutoGen macros from TPL-FILE (deprecated)\0"
/*  1106 */ "LIB_TEMPLATE\0"
/*  1119 */ "lib-template\0"
/*  1132 */ "Read definitions from FILE\0"
/*  1159 */ "DEFINITIONS\0"
/*  1171 */ "no-definitions\0"
/*  1186 */ "no\0"
/*  1189 */ "name or path name of shell to use\0"
/*  1223 */ "SHELL\0"
/*  1229 */ "shell\0"
/*  1235 */ "Do not use in-mem streams\0"
/*  1261 */ "NO_FMEMOPEN\0"
/*  1273 */ "no-fmemopen\0"
/*  1285 */ "characters considered equivalent\0"
/*  1318 */ "EQUATE\0"
/*  1325 */ "equate\0"
/*  1332 */ "_-^\0"
/*  1336 */ "The following options modify how output is handled:\0"
/*  1388 */ "Specify NAME as the base name for output\0"
/*  1429 */ "BASE_NAME\0"
/*  1439 */ "base-name\0"
/*  1449 */ "set mod times to latest source\0"
/*  1480 */ "SOURCE_TIME\0"
/*  1492 */ "no-source-time\0"
/*  1507 */ "Allow output files to be writable\0"
/*  1541 */ "WRITABLE\0"
/*  1550 */ "not-writable\0"
/*  1563 */ "not\0"
/*  1567 */ "The following options are often useful while debugging new templates:\0"
/*  1637 */ "Limit on increment loops\0"
/*  1662 */ "LOOP_LIMIT\0"
/*  1673 */ "loop-limit\0"
/*  1684 */ "Limit server shell operations to SECONDS\0"
/*  1725 */ "TIMEOUT\0"
/*  1733 */ "timeout\0"
/*  1741 */ "tracing level of detail\0"
/*  1765 */ "TRACE\0"
/*  1771 */ "trace\0"
/*  1777 */ "tracing output file or filter\0"
/*  1807 */ "TRACE_OUT\0"
/*  1817 */ "trace-out\0"
/*  1827 */ "Show the definition tree\0"
/*  1852 */ "SHOW_DEFS\0"
/*  1862 */ "show-defs\0"
/*  1872 */ "Show the definitions used\0"
/*  1898 */ "USED_DEFINES\0"
/*  1911 */ "used-defines\0"
/*  1924 */ "Leave a core dump on a failure exit\0"
/*  1960 */ "CORE\0"
/*  1965 */ "core\0"
/*  1970 */ "These options can be used to control what gets processed in the\n"
            "definitions files and template files:\0"
/*  2072 */ "Skip the file with this SUFFIX\0"
/*  2103 */ "SKIP_SUFFIX\0"
/*  2115 */ "skip-suffix\0"
/*  2127 */ "specify this output suffix\0"
/*  2154 */ "SELECT_SUFFIX\0"
/*  2168 */ "select-suffix\0"
/*  2182 */ "name to add to definition list\0"
/*  2213 */ "DEFINE\0"
/*  2220 */ "define\0"
/*  2227 */ "definition list removal pattern\0"
/*  2259 */ "UNDEFINE\0"
/*  2268 */ "undefine\0"
/*  2277 */ "This option is used to automate dependency tracking:\0"
/*  2330 */ "emit make dependency file\0"
/*  2356 */ "MAKE_DEP\0"
/*  2365 */ "make-dep\0"
/*  2374 */ "help, version and option handling:\0"
/*  2409 */ "display extended usage information and exit\0"
/*  2453 */ "help\0"
/*  2458 */ "extended usage information passed thru pager\0"
/*  2503 */ "more-help\0"
/*  2513 */ "output version information and exit\0"
/*  2549 */ "version\0"
/*  2557 */ "reset an option's state\0"
/*  2581 */ "reset-option\0"
/*  2594 */ "abbreviated usage to stdout\0"
/*  2622 */ "usage\0"
/*  2628 */ "save the option state to a config file\0"
/*  2667 */ "save-opts\0"
/*  2677 */ "load options from a config file\0"
/*  2709 */ "LOAD_OPTS\0"
/*  2719 */ "no-load-opts\0"
/*  2732 */ "AUTOGEN\0"
/*  2740 */ "autogen (GNU AutoGen) - The Automated Program Generator - Ver. 5.18\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ <def-file> ]\n\0"
/*  2881 */ "$HOME\0"
/*  2887 */ ".\0"
/*  2889 */ ".autogenrc\0"
/*  2900 */ "autogen-users@lists.sourceforge.net\0"
/*  2936 */ "AutoGen creates text files from templates using external definitions.\n\0"
/*  3007 */ "AutoGen is a tool designed for generating program files that contain\n"
            "repetitive text with varied substitutions.\n\0"
/*  3120 */ "autogen (GNU AutoGen) 5.18\0"
/*  3147 */ "nothing\0"
/*  3155 */ "debug-message\0"
/*  3169 */ "server-shell\0"
/*  3182 */ "templates\0"
/*  3192 */ "block-macros\0"
/*  3205 */ "expressions\0"
...
#define INPUT_SELECT_DESC      (autogen_opt_strs+872)
...
#define TEMPL_DIRS_DESC      (autogen_opt_strs+953)
/** Upper-cased name for the templ-dirs option */
#define TEMPL_DIRS_NAME      (autogen_opt_strs+981)
/** Name string for the templ-dirs option */
#define TEMPL_DIRS_name      (autogen_opt_strs+992)
...
#define OVERRIDE_TPL_DESC      (autogen_opt_strs+1003)
/** Upper-cased name for the override-tpl option */
#define OVERRIDE_TPL_NAME      (autogen_opt_strs+1033)
/** Name string for the override-tpl option */
#define OVERRIDE_TPL_name      (autogen_opt_strs+1046)
...
#define LIB_TEMPLATE_DESC      (autogen_opt_strs+1059)
/** Upper-cased name for the lib-template option */
#define LIB_TEMPLATE_NAME      (autogen_opt_strs+1106)
/** Name string for the lib-template option */
#define LIB_TEMPLATE_name      (autogen_opt_strs+1119)
...
#define DEFINITIONS_DESC      (autogen_opt_strs+1132)
/** Upper-cased name for the definitions option */
#define DEFINITIONS_NAME      (autogen_opt_strs+1159)
/** disablement name for the definitions option */
#define NOT_DEFINITIONS_name  (autogen_opt_strs+1171)
/** disablement prefix for the definitions option */
#define NOT_DEFINITIONS_PFX   (autogen_opt_strs+1186)
...
#define SHELL_DESC      (autogen_opt_strs+1189)
/** Upper-cased name for the shell option */
#define SHELL_NAME      (autogen_opt_strs+1223)
/** Name string for the shell option */
#define SHELL_name      (autogen_opt_strs+1229)
...
#define NO_FMEMOPEN_DESC      (autogen_opt_strs+1235)
/** Upper-cased name for the no-fmemopen option */
#define NO_FMEMOPEN_NAME      (autogen_opt_strs+1261)
/** Name string for the no-fmemopen option */
#define NO_FMEMOPEN_name      (autogen_opt_strs+1273)
...
#define EQUATE_DESC      (autogen_opt_strs+1285)
/** Upper-cased name for the equate option */
#define EQUATE_NAME      (autogen_opt_strs+1318)
/** Name string for the equate option */
#define EQUATE_name      (autogen_opt_strs+1325)
/** The compiled in default value for the equate option argument */
#define EQUATE_DFT_ARG   (autogen_opt_strs+1332)
...
#define OUT_HANDLING_DESC      (autogen_opt_strs+1336)
...
#define BASE_NAME_DESC      (autogen_opt_strs+1388)
/** Upper-cased name for the base-name option */
#define BASE_NAME_NAME      (autogen_opt_strs+1429)
/** Name string for the base-name option */
#define BASE_NAME_name      (autogen_opt_strs+1439)
...
#define SOURCE_TIME_DESC      (autogen_opt_strs+1449)
/** Upper-cased name for the source-time option */
#define SOURCE_TIME_NAME      (autogen_opt_strs+1480)
/** disablement name for the source-time option */
#define NOT_SOURCE_TIME_name  (autogen_opt_strs+1492)
/** disablement prefix for the source-time option */
#define NOT_SOURCE_TIME_PFX   (autogen_opt_strs+1186)
...
#define WRITABLE_DESC      (autogen_opt_strs+1507)
/** Upper-cased name for the writable option */
#define WRITABLE_NAME      (autogen_opt_strs+1541)
/** disablement name for the writable option */
#define NOT_WRITABLE_name  (autogen_opt_strs+1550)
/** disablement prefix for the writable option */
#define NOT_WRITABLE_PFX   (autogen_opt_strs+1563)
...
#define DEBUG_TPL_DESC      (autogen_opt_strs+1567)
...
#define LOOP_LIMIT_DESC      (autogen_opt_strs+1637)
/** Upper-cased name for the loop-limit option */
#define LOOP_LIMIT_NAME      (autogen_opt_strs+1662)
/** Name string for the loop-limit option */
#define LOOP_LIMIT_name      (autogen_opt_strs+1673)
...
#define TIMEOUT_DESC      (autogen_opt_strs+1684)
/** Upper-cased name for the timeout option */
#define TIMEOUT_NAME      (autogen_opt_strs+1725)
/** Name string for the timeout option */
#define TIMEOUT_name      (autogen_opt_strs+1733)
...
#define TRACE_DESC      (autogen_opt_strs+1741)
/** Upper-cased name for the trace option */
#define TRACE_NAME      (autogen_opt_strs+1765)
/** Name string for the trace option */
#define TRACE_name      (autogen_opt_strs+1771)
...
#define TRACE_OUT_DESC      (autogen_opt_strs+1777)
/** Upper-cased name for the trace-out option */
#define TRACE_OUT_NAME      (autogen_opt_strs+1807)
/** Name string for the trace-out option */
#define TRACE_OUT_name      (autogen_opt_strs+1817)
...
#define SHOW_DEFS_DESC      (autogen_opt_strs+1827)
/** Upper-cased name for the show-defs option */
#define SHOW_DEFS_NAME      (autogen_opt_strs+1852)
/** Name string for the show-defs option */
#define SHOW_DEFS_name      (autogen_opt_strs+1862)
...
#define USED_DEFINES_DESC      (autogen_opt_strs+1872)
/** Upper-cased name for the used-defines option */
#define USED_DEFINES_NAME      (autogen_opt_strs+1898)
/** Name string for the used-defines option */
#define USED_DEFINES_name      (autogen_opt_strs+1911)
...
#define CORE_DESC      (autogen_opt_strs+1924)
/** Upper-cased name for the core option */
#define CORE_NAME      (autogen_opt_strs+1960)
/** Name string for the core option */
#define CORE_name      (autogen_opt_strs+1965)
...
#define PROCESSING_DESC      (autogen_opt_strs+1970)
...
#define SKIP_SUFFIX_DESC      (autogen_opt_strs+2072)
/** Upper-cased name for the skip-suffix option */
#define SKIP_SUFFIX_NAME      (autogen_opt_strs+2103)
/** Name string for the skip-suffix option */
#define SKIP_SUFFIX_name      (autogen_opt_strs+2115)
...
#define SELECT_SUFFIX_DESC      (autogen_opt_strs+2127)
/** Upper-cased name for the select-suffix option */
#define SELECT_SUFFIX_NAME      (autogen_opt_strs+2154)
/** Name string for the select-suffix option */
#define SELECT_SUFFIX_name      (autogen_opt_strs+2168)
...
#define DEFINE_DESC      (autogen_opt_strs+2182)
/** Upper-cased name for the define option */
#define DEFINE_NAME      (autogen_opt_strs+2213)
/** Name string for the define option */
#define DEFINE_name      (autogen_opt_strs+2220)
...
#define UNDEFINE_DESC      (autogen_opt_strs+2227)
/** Upper-cased name for the undefine option */
#define UNDEFINE_NAME      (autogen_opt_strs+2259)
/** Name string for the undefine option */
#define UNDEFINE_name      (autogen_opt_strs+2268)
...
#define DEP_TRACK_DESC      (autogen_opt_strs+2277)
...
#define MAKE_DEP_DESC      (autogen_opt_strs+2330)
/** Upper-cased name for the make-dep option */
#define MAKE_DEP_NAME      (autogen_opt_strs+2356)
/** Name string for the make-dep option */
#define MAKE_DEP_name      (autogen_opt_strs+2365)
...
#define AUTOOPTS_OPTS_DESC      (autogen_opt_strs+2374)
#define AUTOOPTS_OPTS_FLAGS     (OPTST_DOCUMENT | OPTST_NO_INIT)

/*
 *  Help/More_Help/Version option descriptions:
 */
#define HELP_DESC       (autogen_opt_strs+2409)
#define HELP_name       (autogen_opt_strs+2453)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (autogen_opt_strs+2458)
#define MORE_HELP_name  (autogen_opt_strs+2503)
...
#endif
#define VER_DESC        (autogen_opt_strs+2513)
#define VER_name        (autogen_opt_strs+2549)
#define RESET_DESC      (autogen_opt_strs+2557)
#define RESET_name      (autogen_opt_strs+2581)
#define RESET_FLAGS     (OPTST_SET_ARGTYPE(OPARG_TYPE_STRING)|OPTST_NO_INIT)
#define USAGE_DESC      (autogen_opt_strs+2594)
#define USAGE_name      (autogen_opt_strs+2622)
#define SAVE_OPTS_DESC  (autogen_opt_strs+2628)
#define SAVE_OPTS_name  (autogen_opt_strs+2667)
#define LOAD_OPTS_DESC     (autogen_opt_strs+2677)
#define LOAD_OPTS_NAME     (autogen_opt_strs+2709)
#define NO_LOAD_OPTS_name  (autogen_opt_strs+2719)
#define LOAD_OPTS_pfx      (autogen_opt_strs+1186)
...
doOptOverride_Tpl(tOptions* pOptions, tOptDesc* pOptDesc)
{
     ...
     * reset its state.
     */
    /* extracted from opts.def, line 177 */
...
doOptLib_Template(tOptions* pOptions, tOptDesc* pOptDesc)
{
     ...
     * reset its state.
     */
    /* extracted from opts.def, line 201 */
    templ_t * tpl;
...
doOptShell(tOptions* pOptions, tOptDesc* pOptDesc)
{
     ...
     * reset its state.
     */
    /* extracted from opts.def, line 251 */
...
/* extracted from optmain.tlib near line 962 */
    static char const * const names[7] = {
        autogen_opt_strs+3147, autogen_opt_strs+3155, autogen_opt_strs+3169,
        autogen_opt_strs+3182, autogen_opt_strs+3192, autogen_opt_strs+3205,
        autogen_opt_strs+3217 };
...
doOptSelect_Suffix(tOptions* pOptions, tOptDesc* pOptDesc)
{
     ...
     * reset its state.
     */
    /* extracted from opts.def, line 614 */
